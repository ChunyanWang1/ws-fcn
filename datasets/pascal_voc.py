...
class VOCSegmentation(PascalVOC):
    ...
    def __init__(self, cfg, split, test_mode, scales=(1.0,),root=os.path.expanduser('./data')):
        self.scales = scales
