...
def add_global_arguments(parser):
    ...
    parser.add_argument("--exp", type=str, default='baselines',#'default="main",
                        help="ID of the experiment (multiple runs)")
    parser.add_argument("--resume", type=str, default=None,#'e020Xs0.904',#'None,
                        help="Snapshot \"ID,iter\" to load")
    parser.add_argument("--run", type=str, default='v01',help="ID of the run")
    ...
    parser.add_argument("--train_list", default="data/train_augvoc.txt", type=str)
    parser.add_argument("--val_list", default="data/val_voc.txt", type=str)




    # used at inference only
    parser.add_argument("--infer-list", type=str, default='data/val_voc.txt',
    ...
    #
    parser.add_argument(
        '--cfg', dest='cfg_file', default='configs/voc_resnet38.yaml',
